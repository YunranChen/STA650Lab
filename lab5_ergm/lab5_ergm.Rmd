...
- model estimation `ergm`

- model-based network simulation `simulate`

- network visualization `plot`

- model evaluation `gof`

This broad functionality is powered by a central **Markov chain Monte Carlo (MCMC)** algorithm.
